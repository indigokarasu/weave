# Weave Self-Update Procedure

`weave.update` pulls the latest package from the `source:` URL in SKILL.md frontmatter. Runs silently — no output unless the version changed or an error occurred.
