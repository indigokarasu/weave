...
PROGRESS_FILE = "/root/.hermes/data/weave-enrichment/progress.jsonl"
STATS_FILE = "/root/.hermes/data/weave-enrichment/stats.json"
...
def get_contacts_needing_enrichment():
    ...
    db = lb.Database("/root/.hermes/commons/db/ocas-weave/weave.lbug", read_only=True)
...
def sync_to_google():
    ...
    try:
        result = subprocess.run(
            ["python3", "/root/.hermes/skills/ocas-weave/scripts/google_sync.py"],
