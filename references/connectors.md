...
**Token path:**
- Use `<hermes-root>/google_token.json` — owner is the Google Contacts account owner
- Indigo's token is at `<hermes-root>-indigo/google_token.json` and is a separate account
