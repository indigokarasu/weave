...
```bash
python3 -c "import json; td=json.load(open('/root/.google_workspace_mcp/credentials/google-workspace-user.json')); print(td.get('scopes', []))"
```
...
Correct path: `TOKEN_PATH = '/root/.google_workspace_mcp/credentials/google-workspace-user.json'`
...
- **Wrong file**: Patch `TOKEN_PATH` to `/root/.google_workspace_mcp/credentials/google-workspace-user.json`
